...
public class TlsResource implements AutoCloseable
{
    ...
    public Path createKeyStore()
    {
        return createKeyStore(getKeyStoreType(), List.of());
    }

    public Path createKeyStore(final KeyStoreEntry entry)
    {
        return createKeyStore(getKeyStoreType(), List.of(entry));
    }

    public Path createKeyStore(final KeyStoreEntry entry1, final KeyStoreEntry entry2)
    {
        return createKeyStore(getKeyStoreType(), List.of(entry1, entry2));
    }

    public Path createKeyStore(final KeyStoreEntry entry1, final KeyStoreEntry entry2, final KeyStoreEntry entry3)
    {
        return createKeyStore(getKeyStoreType(), List.of(entry1, entry2, entry3));
    }

    public Path createKeyStore(final List<KeyStoreEntry> entries)
    {
        return createKeyStore(getKeyStoreType(), entries);
    }

    public Path createKeyStore(final String keyStoreType, final KeyStoreEntry entry)
    {
        return createKeyStore(keyStoreType, List.of(entry));
    }

    public Path createKeyStore(final String keyStoreType, final List<KeyStoreEntry> entries)
    {
    ...
    public String createKeyStoreAsDataUrl()
    {
        return createKeyStoreAsDataUrl(List.of());
    }

    public String createKeyStoreAsDataUrl(final KeyStoreEntry entry)
    {
        return createKeyStoreAsDataUrl(List.of(entry));
    }

    public String createKeyStoreAsDataUrl(final KeyStoreEntry entry1, final KeyStoreEntry entry2)
    {
        return createKeyStoreAsDataUrl(List.of(entry1, entry2));
    }

    public String createKeyStoreAsDataUrl(final KeyStoreEntry entry1, final KeyStoreEntry entry2, final KeyStoreEntry entry3)
    {
        return createKeyStoreAsDataUrl(List.of(entry1, entry2, entry3));
    }

    public String createKeyStoreAsDataUrl(final List<KeyStoreEntry> entries)
    {
