...
{
    @Test
    public void testNewTokenUsesCurrentSubject()
    {
    ...
    @Test
    public void testNewTokenUsesProvidedSubject() throws Exception
    {
        final Subject subject = new Subject(false, Set.of((Principal) () -> getTestName()), Set.of(), Set.of());
    ...
    @Test
    public void testAuthoriseWithNullTokenUsesCurrentSubject()
    {
        final Subject subject = new Subject(false, Set.of((Principal) () -> getTestName()), Set.of(), Set.of());
        final AtomicReference<Subject> seenSubject = new AtomicReference<>();
