...
class AutoGeneratedSelfSignedKeyStoreTest extends UnitTestBase
{
    ...
    private AutoGeneratedSelfSignedKeyStore<?> _keyStore;
    ...
    void beforeAll()
    {
        _keyStore = createAutoGeneratedSelfSignedKeyStore();
    }
    ...
    private AutoGeneratedSelfSignedKeyStore<?> createAutoGeneratedSelfSignedKeyStore()
    {
        ...
        return (AutoGeneratedSelfSignedKeyStore<?>) _configuredObjectFactory.create(KeyStore.class, attributes, _broker);
    }
}
