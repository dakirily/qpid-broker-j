...
public class SimpleLDAPAuthenticationManagerExceptionHandlingTest extends UnitTestBase
{
    ...
    @Test
    public void testDoLDAPNameAuthenticationRethrowsRuntimeException() throws Exception
    {
    ...
    public void testValidateInitialDirContextRethrowsRuntimeException() throws Exception
    {
