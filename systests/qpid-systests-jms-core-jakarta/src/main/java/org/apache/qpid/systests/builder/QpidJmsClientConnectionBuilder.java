...
public class QpidJmsClientConnectionBuilder implements ConnectionBuilder
{
    ...
    @Override
    public ConnectionBuilder host(final String host)
    {
        _host = host;
        return this;
    }
    ...
    @Override
    public ConnectionBuilder failoverPort(final int port)
    {
    ...
    @Override
    public ConnectionBuilder prefetch(final int prefetch)
    {
    ...
    @Override
    public ConnectionBuilder clientId(final String clientId)
    {
        if (clientId == null)
        {
    ...
    @Override
    public ConnectionBuilder username(final String username)
    {
        if (username == null)
        {
    ...
    @Override
    public ConnectionBuilder virtualHost(final String virtualHostName)
    {
    ...
    @Override
    public ConnectionBuilder failover(final boolean enableFailover)
    {
    ...
    @Override
    public ConnectionBuilder failoverReconnectAttempts(final int reconnectAttempts)
    {
    ...
    @Override
    public ConnectionBuilder failoverReconnectDelay(final int connectDelay)
    {
    ...
    @Override
    public ConnectionBuilder tls(final boolean enableTls)
    {
    ...
    @Override
    public ConnectionBuilder syncPublish(final boolean syncPublish)
    {
    ...
    @Override
    public ConnectionBuilder options(final Map<String, String> options)
    {
    ...
    @Override
    public ConnectionBuilder populateJMSXUserID(final boolean populateJMSXUserID)
    {
    ...
    @Override
    public ConnectionBuilder deserializationPolicyAllowList(final String allowList)
    {
    ...
    @Override
    public ConnectionBuilder deserializationPolicyDenyList(final String blackList)
    {
    ...
    @Override
    public ConnectionBuilder keyStoreLocation(final String keyStoreLocation)
    {
    ...
    @Override
    public ConnectionBuilder keyStorePassword(final String keyStorePassword)
    {
    ...
    @Override
    public ConnectionBuilder trustStoreLocation(final String trustStoreLocation)
    {
    ...
    @Override
    public ConnectionBuilder trustStorePassword(final String trustStorePassword)
    {
    ...
    @Override
    public ConnectionBuilder verifyHostName(final boolean verifyHostName)
    {
    ...
    @Override
    public ConnectionBuilder keyAlias(final String alias)
    {
    ...
    @Override
    public ConnectionBuilder saslMechanisms(final String... mechanism)
    {
    ...
    @Override
    public Connection create() throws NamingException, JMSException
    {
        return connectionFactory().createConnection();
    }

    @Override
    public <T extends Connection> T create(final Class<T> type) throws NamingException, JMSException
    {
        return type.cast(connectionFactory().createConnection());
    }
    ...
    public String connectionURL()
    {
        ...
        final Map<String, Object> options = new TreeMap<>(_options);
        ...
        if (_enableFailover)
        {
            ...
            final Set<String> transportKeys = options.keySet()
                    .stream()
                    .filter(key -> key.startsWith("amqp.") || key.startsWith("transport."))
    ...
    @Override
    public ConnectionBuilder transport(final String transport)
    {
    ...
    private void appendOptions(final Map<String, Object> actualOptions, final StringBuilder stem)
    {
        ...
        for(Map.Entry<String, Object> option : actualOptions.entrySet())
        {
            ...
            stem.append(option.getKey()).append('=').append(URLEncoder.encode(String.valueOf(option.getValue()), StandardCharsets.UTF_8));
        }
    }
