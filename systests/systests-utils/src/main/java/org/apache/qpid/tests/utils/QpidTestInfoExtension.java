...
public class QpidTestInfoExtension implements ParameterResolver
{
    @Override
    ...
    {
        return QpidTestInfo.class.equals(parameterContext.getParameter().getType());
    }
            ...
            throws ParameterResolutionException
    {
        ...
        final var testName = extensionContext.getRequiredTestMethod().getName();
        return new QpidTestInfo(className, testName);
    }
}
