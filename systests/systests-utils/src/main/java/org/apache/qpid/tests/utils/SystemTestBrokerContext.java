...
public final class SystemTestBrokerContext
{
    private static final Map<String, String> RESOURCE_DEFAULTS = Map.of(
            AmqpPort.PORT_AMQP_THREAD_POOL_SIZE, "4",
            AmqpPort.PORT_AMQP_NUMBER_OF_SELECTORS, "1",
            QueueManagingVirtualHost.VIRTUALHOST_CONNECTION_THREAD_POOL_SIZE, "4",
            QueueManagingVirtualHost.VIRTUALHOST_CONNECTION_THREAD_POOL_NUMBER_OF_SELECTORS, "1",
            HttpPort.PORT_HTTP_THREAD_POOL_MINIMUM, "4",
            HttpPort.PORT_HTTP_THREAD_POOL_MAXIMUM, "8",
            HttpPort.PORT_HTTP_NUMBER_OF_SELECTORS, "2",
            HttpPort.PORT_HTTP_NUMBER_OF_ACCEPTORS, "1");

    private static final List<String> BROKER_SYSTEM_PROPERTY_PREFIXES =
            List.of("qpid.", "virtualhost.", "port.http.");
