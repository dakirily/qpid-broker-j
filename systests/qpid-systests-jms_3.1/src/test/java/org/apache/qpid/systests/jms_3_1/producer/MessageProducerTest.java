...
{
    @Test
    void produceToUnknownQueue(final JmsSupport jms) throws Exception
    {
             ...
             final var session = connection.createSession(false, Session.AUTO_ACKNOWLEDGE))
        {
            ...
            assertThrows(JMSException.class, () ->
                    {
                        final var sender = session.createProducer(invalidDestination);
    ...
    void anonymousSenderSendToUnknownQueue(final JmsSupport jms) throws Exception
    {
             ...
             final var session = connection.createSession(false, Session.AUTO_ACKNOWLEDGE))
        {
            ...
            assertThrows(JMSException.class, () ->
                    {
                        final var sender = session.createProducer(null);
