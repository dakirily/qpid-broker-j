...
import org.apache.qpid.test.utils.tls.utils.PEMUtils;
...
import org.apache.qpid.test.utils.tls.utils.TlsResourceBuilder;
...
public class PortTest extends HttpTestBase
{
                                          ...
                                          final KeyCertificatePair keyCertPair) throws Exception
    {
        ...
        attributes.put(NonJavaKeyStore.PRIVATE_KEY_URL,
                       DataUrlUtils.getDataUrlForBytes(PEMUtils.toPEM(keyCertPair.privateKey())
                                                                        .getBytes(UTF_8)));
        attributes.put(NonJavaKeyStore.CERTIFICATE_URL,
                       DataUrlUtils.getDataUrlForBytes(PEMUtils.toPEM(keyCertPair.certificate())
                                                                        .getBytes(UTF_8)));
