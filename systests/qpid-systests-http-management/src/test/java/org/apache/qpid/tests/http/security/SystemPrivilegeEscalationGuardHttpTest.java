...
public class SystemPrivilegeEscalationGuardHttpTest extends HttpTestBase
{
    ...
    public void setUp()
    {
        getBrokerAdmin().createQueue(Q1);
        getBrokerAdmin().createQueue(Q2);
    }
    ...
    public void guestCannotDeleteQueueEvenIfSystemRuleWouldAllow() throws Exception
    {
        ...
        getHelper().submitRequest("queue/" + Q1, "GET", SC_OK);
        ...
        int rc = guest.submitRequest("queue/" + Q1, "DELETE");
    ...
    public void guestCannotBulkDeleteQueues() throws Exception
    {
        ...
        getHelper().submitRequest("queue/" + Q1, "GET", SC_OK);
        getHelper().submitRequest("queue/" + Q2, "GET", SC_OK);
    }
    ...
    public void adminCanDeleteQueue() throws Exception
    {
        ...
        admin.submitRequest("queue/" + Q1, "DELETE", SC_OK);
        admin.submitRequest("queue/" + Q1, "GET", SC_NOT_FOUND);
    }
}
