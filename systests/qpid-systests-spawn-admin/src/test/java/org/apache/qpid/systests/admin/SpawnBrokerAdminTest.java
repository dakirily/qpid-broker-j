...
public class SpawnBrokerAdminTest extends UnitTestBase
{
    ...
    public void resourcePropertiesArePropagated() throws Exception
    {
        ...
        try (SpawnBrokerAdmin admin = new SpawnBrokerAdmin())
        {
            ...
            final Map<String, Object> portAttributes =
                    admin.getAttributes(true, "AMQP", "org.apache.qpid.AmqpPort");
            final Map<String, Object> virtualHostAttributes =
                    admin.getAttributes(false, admin.getVirtualHostName(), "org.apache.qpid.VirtualHost");
            ...
            assertThat(((Number) virtualHostAttributes.get(QueueManagingVirtualHost.CONNECTION_THREAD_POOL_SIZE))
                               .intValue(),
                       is(equalTo(6)));
