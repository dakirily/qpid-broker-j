...
class UnsignedIntegerWriterTest extends UnitTestBase
{
    ...
    {
        final ValueWriter<UnsignedInteger> writer =
                TYPE_REGISTRY.getValueWriter(UnsignedInteger.valueOf(value));
