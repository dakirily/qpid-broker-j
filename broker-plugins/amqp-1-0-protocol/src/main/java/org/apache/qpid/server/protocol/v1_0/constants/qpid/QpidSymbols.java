...
{
    Symbol ANNOTATION_KEY = Symbol.valueOf(QpidSymbolTexts.ANNOTATION_KEY);
    ...
    Symbol DELIVERY_TIME = Symbol.valueOf(QpidSymbolTexts.DELIVERY_TIME);
    ...
    Symbol SOLE_CONNECTION_DETECTION_POLICY = Symbol.valueOf(QpidSymbolTexts.SOLE_CONNECTION_DETECTION_POLICY);
    Symbol SOLE_CONNECTION_ENFORCEMENT = Symbol.valueOf(QpidSymbolTexts.SOLE_CONNECTION_ENFORCEMENT);
    Symbol SOLE_CONNECTION_ENFORCEMENT_POLICY = Symbol.valueOf(QpidSymbolTexts.SOLE_CONNECTION_ENFORCEMENT_POLICY);
    Symbol SOLE_CONNECTION_FOR_CONTAINER = Symbol.valueOf(QpidSymbolTexts.SOLE_CONNECTION_FOR_CONTAINER);
}
