...
public class FlowWriter extends AbstractDescribedTypeWriter<Flow>
{
    ...
    private static class Writer extends AbstractListWriter<Flow>
    {
        ...
        protected Object next()
        {
            ...
            {
                case 0 -> _value.getNextIncomingId();
                case 1 -> _value.getIncomingWindow();
                case 2 -> _value.getNextOutgoingId();
                case 3 -> _value.getOutgoingWindow();
                case 4 -> _value.getHandle();
                case 5 -> _value.getDeliveryCount();
                case 6 -> _value.getLinkCredit();
                case 7 -> _value.getAvailable();
                case 8 -> _value.getDrain();
                case 9 -> _value.getEcho();
                case 10 -> _value.getProperties();
                default -> null;
            };
        }
