...
public interface CapabilitiesAware extends SymbolAware
{
    ...
    default Symbol[] filterCapabilities(final Symbol symbol1,
                                        final Symbol symbol2,
                                        final Symbol symbol3)
    {
        return filterSymbols(getCapabilities(), symbol1, symbol2, symbol3);
    }
}
