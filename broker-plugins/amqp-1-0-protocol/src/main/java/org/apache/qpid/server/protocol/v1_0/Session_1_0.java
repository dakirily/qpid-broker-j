        ...
        implements LogSubject, org.apache.qpid.server.util.Deletable<Session_1_0>
{
                                              ...
                                              final Terminus terminus) throws AmqpErrorException
    {
        ...
        try
        {
            ...
            if (terminus.hasCapability(Symbols.TEMPORARY_QUEUE) || terminus.hasCapability(Symbols.TEMPORARY_TOPIC))
            {
    ...
    private MessageDestination createDynamicDestination(final Link_1_0<?, ?> link,
                                                        final Terminus terminus) throws AmqpErrorException
    {
        boolean isTopic = terminus.hasCapability(Symbols.TEMPORARY_TOPIC) || terminus.hasCapability(Symbols.TOPIC);
        ...
        try
        {
            ...
            else if (terminus.hasCapability(Symbols.TEMPORARY_QUEUE))
            {
                attributes.put(Queue.EXCLUSIVE, ExclusivityPolicy.CONNECTION);
            }
