...
public class TrimExpressionTest
{
    ...
    public void threeArguments()
    {
        ...
        assertEquals("Function 'TRIM' requires maximum 2 parameters", exception.getMessage());
    }
    ...
    public void noArguments()
    {
        ...
        QueryParsingException exception = assertThrows(QueryParsingException.class, () -> _queryEvaluator.execute(query));
        assertEquals("Function 'TRIM' requires at least 1 parameter", exception.getMessage());
    }
    ...
    public void invalidArgumentType()
    {
        ...
        assertEquals("Parameter of function 'TRIM' invalid (parameter type: HashMap)", exception.getMessage());
    }
}
