...
public class LessThanOrEqualExpressionTest
{
    ...
    private static Stream<Arguments> integerQueries()
    {
        return Stream.of(
                ...
                Arguments.of("select 0 <= 0 as result", true),
    ...
    private static Stream<Arguments> longQueries()
    {
        return Stream.of(
                ...
                Arguments.of("select 1L <= 1L as result", true),
                ...
                Arguments.of("select -2L <= -2L as result", true)
        );
    }
    ...
    private static Stream<Arguments> doubleQueries()
    {
        return Stream.of(
                ...
                Arguments.of("select 1/4 <= 3/12 as result", true),
                Arguments.of("select 0 <= -1/2 as result", false),
                Arguments.of("select -1/3 <= -2/3 as result", false),
                Arguments.of("select -1/3 <= -3/9 as result", true)
        );
    }
    ...
    private static Stream<Arguments> stringQueries()
    {
        return Stream.of(
                ...
                Arguments.of("select 'test124' <= 'test124' as result", true)
        );
    }
