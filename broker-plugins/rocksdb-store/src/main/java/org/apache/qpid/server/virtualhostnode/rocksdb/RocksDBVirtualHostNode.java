...
/**
 * Defines a RocksDB-backed virtual host node.
 *
                ...
                RocksDBManagedSettings<X>
{
    ...
    /**
     * Returns the store path for configuration data.
     *
     * @return the store path.
     */
    @Override
    @ManagedAttribute(mandatory = true,
                      defaultValue = "${qpid.work_dir}${file.separator}${this:name}${file.separator}config")
    String getStorePath();
