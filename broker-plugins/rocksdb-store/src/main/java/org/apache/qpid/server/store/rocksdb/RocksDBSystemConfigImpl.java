...
/**
 * Implements system configuration for the RocksDB store.
 * <br>
 * Thread-safety: safe for concurrent access by the configuration model.
 */
@ManagedObject(category = false, type = RocksDBSystemConfigImpl.SYSTEM_CONFIG_TYPE)
public class RocksDBSystemConfigImpl extends AbstractSystemConfig<RocksDBSystemConfigImpl>
        implements RocksDBSystemConfig<RocksDBSystemConfigImpl>
{
    /**
     * The managed object type name.
     */
    public static final String SYSTEM_CONFIG_TYPE = "ROCKSDB";
    ...
    /**
     * Creates a RocksDB system configuration instance.
     *
     * @param taskExecutor task executor.
     * @param eventLogger event logger.
     * @param systemPrincipal system principal.
     * @param attributes configuration attributes.
     */
    @SystemConfigFactoryConstructor
    public RocksDBSystemConfigImpl(final TaskExecutor taskExecutor,
    ...
    {
        return new RocksDBConfigurationStore(Broker.class);
    }
    ...
    /**
     * Returns the underfull size threshold.
     *
    ...
    /**
     * Returns the overfull size threshold.
     *
