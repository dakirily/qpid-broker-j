...
public class SaslServletTest
{
    ...
    @Test
    public void testDoGetUsesAuthenticatedPrincipalFromSubject() throws Exception
    {
    ...
    @Test
    public void testDoGetFallsBackToRemoteUserWhenSubjectMissing() throws Exception
    {
