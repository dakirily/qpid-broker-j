...
{
    @Test
    public void testInvokeAuthenticationHandlerPropagatesIOException() throws Exception
    {
    ...
    @Test
    public void testInvokeAuthenticationHandlerPropagatesRuntimeException() throws Exception
    {
        final InteractiveAuthenticationFilter filter = new InteractiveAuthenticationFilter();
        final HttpServletRequest request = createHttpRequest();
        final HttpServletResponse response = mock(HttpServletResponse.class);
