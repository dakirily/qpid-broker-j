    ...
    private void corruptDatabase()
    {
        CursorOperation cursorOperation = new CursorOperation()
        {
                    ...
                    DatabaseEntry key, DatabaseEntry value)
            {
                ...
                LOGGER.info("Deliberately corrupted message id {}, changed offset from {} to {}", originalCompoundKey.getMessageId(), originalCompoundKey.getOffset(), corruptedCompoundKey.getOffset());
