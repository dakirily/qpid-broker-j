...
public class BDBVirtualHostNodeImpl extends AbstractStandardVirtualHostNode<BDBVirtualHostNodeImpl> implements BDBVirtualHostNode<BDBVirtualHostNodeImpl>
{
    ...
    {
        final EnvironmentFacade environmentFacade = getEnvironmentFacade();
        return null != environmentFacade ? environmentFacade.cleanLog() : 0;
    }
    ...
    public EnvironmentFacade getEnvironmentFacade()
    {
        ...
        return null != bdbConfigurationStore ? bdbConfigurationStore.getEnvironmentFacade() : null;
    }
